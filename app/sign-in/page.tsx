    ...
    <div className="min-h-screen flex items-center justify-center bg-bg">
      <div className="card max-w-md w-full mx-4 p-8">
        <h1 className="text-2xl font-bold text-center mb-6 text-text">
          Sign In — Startup Valuation
        </h1>

        <div className="space-y-4">
          <button
            onClick={() => signIn("github", { callbackUrl: "/dashboard" })}
            className="w-full flex items-center justify-center gap-3 border border-border rounded-lg px-4 py-3 text-text hover:bg-gray-50 transition-colors"
          >
          ...
          <form onSubmit={handleCredentials} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="input"
                placeholder="demo@startup-valuation.com"
                required
              />
            </div>
            <div>
