...
/**
 * Federal Reserve (FRED) source — interest rates and economic indicators.
 * Reads `etl/data/fred.csv` with columns:
 *   name,value,unit,valid_from,
 *   source_url,source_name,source_retrieved_at,source_version
 */
export async function importFred(filePath = "etl/data/fred.csv") {
