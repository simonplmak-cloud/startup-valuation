...
> Bidirectional links: code → docs → Wiki → textbook. Auto-generated from docstring metadata.

## Core Methods (`core.py`)
...
| Module | Textbook Chapter | Wiki Page | Status |
|---|---|---|---|
| `probability.py` | Ch. 2 | — | Phase 2 |
| `tv.py` | Ch. 2 | — | Phase 2 |
| `capm.py` | Ch. 2 | — | Phase 2 |
| `comparables.py` | Ch. 5 | — | Phase 2 |
| `saas.py` | Ch. 11 | — | Phase 2 |
| `biotech.py` | Ch. 11 | — | Phase 2 |
| `fintech.py` | Ch. 11 | — | Phase 2 |
| `marketplace.py` | Ch. 11 | — | Phase 2 |
| `hardware.py` | Ch. 11 | — | Phase 2 |
| `international.py` | Ch. 12 | — | Phase 2 |
| `stakeholders.py` | Ch. 13 | — | Phase 2 |
| `emerging.py` | Ch. 14 | — | Phase 2 |
