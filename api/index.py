...
TOOLS = {
    ...
    "valuation_scorecard": {
        ...
        "description": "Scorecard valuation method: adjust average valuation by weighted factor scores for pre-revenue startups.",  # noqa: E501
    },
    "valuation_berkus": {
    ...
    "valuation_acquisition": {
        "fn": lambda standalone_value, revenue_synergies, cost_synergies, integration_costs, prob_revenue, prob_cost: _unwrap(  # noqa: E501
            stakeholders.acquisition_value(
                standalone_value, revenue_synergies, cost_synergies,
                integration_costs, prob_revenue, prob_cost,
            )
        ),
        "schema": {
            "standalone_value": "number", "revenue_synergies": "number",
            "cost_synergies": "number", "integration_costs": "number",
            "prob_revenue": "number", "prob_cost": "number",
        },
    ...
    "valuation_pwerm": {
        ...
        "schema": {"outcomes": "array", "probabilities": "array"},
        "description": "PWERM: Probability-Weighted Expected Return Method for multi-scenario valuation. Each scenario: {probability, value}.",  # noqa: E501
    },
